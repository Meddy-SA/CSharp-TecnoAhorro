...
public class UserHandleService(
    ...
    ILogger<UserHandleService> logger,
    ISysMenu sysMenu,
    Context context,
    IMapper mapper
) : IUserHandle
{
    ...
    private readonly ILogger<UserHandleService> logger = logger;
    ...
    public async Task<ResponseDTO<PreRegisterDTO>> PreRegister(PreRegisterDTO preRegister)
    {
        try
        {
    ...
    {
        ResponseDTO<AppUserDTO> responseDTO = new();
